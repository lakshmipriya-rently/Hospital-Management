...
RSpec.describe AppointmentsController, type: :controller do
  ...
  describe 'GET #new' do
    before do
      allow(controller).to receive(:set_appointment_context) do
        ...
        allow(controller).to receive_messages(authenticate_patient!: true, current_user: patient_user)
        get :new
    end
  ...
  describe 'POST #create' do
    ...
    context 'with invalid params' do
      ...
      it 'renders new with unprocessable_entity' do
        ...
        expect(response.body).to include('Appointment')
        end
      end
    end
  end
  ...
  describe 'PATCH #update' do
    ...
    context 'when doctor is authorized' do
      before do
        allow(controller).to receive_messages(authenticate_doctor!: true, current_user: doctor_user)
      end
      ...
      it 'after updates appointment redirects' do
        patch :update, params: { id: appointment.id, appointment: { disease: 'New' } }
